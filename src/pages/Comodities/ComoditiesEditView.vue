...
const dispatch = async () => {
  try {
    ...
    await store.dispatch("fetchCommodity", id)
...
const search = () => {
  ...
  const filteredCommodities = commodities.value.filter(item => {
    return item.mtrName.toLowerCase().includes(search.toLowerCase())
  })

  if(!search){
    return commodities.value = store.getters.commodities
  }
            ...
            >
              <div class="d-flex mt-4">
                ...
                <div>
                  <div class="d-flex">
                    <div class="info">
                      <span class="font-weight-semibold me-2 mb-4">Commodity: {{ item.mtrName }}</span>
                    </div>
                    <div class="icon">
                      <VBtn
                        icon="mdi-pencil"
                ...
                <VCardText>
                  <div class="icons d-flex justify-end">
                    ...
                    >
                      ...
                      <VCard>
                        ...
                        <VCardText>
                          Are you sure you want to delete this comodity?
                        </VCardText>
                        <VCardActions>
                          <VSpacer />
                          <VBtn
                  ...
                  <div class="d-flex">
                    ...
                    <div>
                      ...
                      <p class="mb-2">
                        Please fill in the form below to edit selected comodity
                      </p>
                    </div>
                  </div>
                </VCardText>
