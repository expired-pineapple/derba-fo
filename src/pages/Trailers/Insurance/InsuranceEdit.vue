...
const dispatch = async () => {
  try {
    ...
    await store.dispatch("fetchTrailerInsurance", id)
    ...
    data.value = store.getters.trailerInsurances
...
const deleteItem = async item => {
  ...
  await store.dispatch('deleteTrailerInsurance', item.id)
  await dispatch()
            ...
            >
              <div class="d-flex mt-4">
                ...
                <div>
                  <div class="d-flex">
                    <div class="info">
                      <span class="font-weight-semibold me-2 mb-4">Insurance: {{ item.trlInsRegistrationNo }}</span>
                    </div>
                    <div class="icon">
                      <VBtn
                        icon="mdi-pencil"
                  ...
                  <VForm @submit.prevent="submitForm">
                    <VContainer>
                      <VRow>
                        ...
                        <VCol cols="12">
                          <VSwitch
                            v-model="insurance.trlInscActive"
                            label="Active"
                          />
                        </VCol>
                      </VRow>
