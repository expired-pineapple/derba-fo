...
const headers = [
  { text: "ID", value: "id", sortable: true, width: "30" },
  { text: "Maintainenace Provider", value: "maintenanceProvider.maintainenaceProvider", sortable: true },
  { text: "Date", value: "maintenanceDate", sortable: true },
  { text: "Remark", value: "maintenanceRemark", sortable: true },
